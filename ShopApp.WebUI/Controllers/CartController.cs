...
namespace ShopApp.WebUI.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public Payment PaymentProcess(OrderModel model)
        {
            Options options = new Options();
            options.ApiKey = "sandbox-BQUPCeAy0F9ED4hB1mOZknBsnfdYnHPe";
            options.SecretKey = "sandbox-IVHe4vOpzy8wcQSWdzLBl36HUJXxgbSL";
            ...
            request.BasketId = new Random().Next(111111111, 999999999).ToString();
            ...
            shippingAddress.ContactName = model.FirstName + " " + model.FirstName;
